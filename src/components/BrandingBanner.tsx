...
export default function BrandingBanner() {
    return (
        <section className="relative w-full h-[350px] md:h-[200px] bg-[#2a7dc9] -mt-10 md:-mt-14 z-20">
            ...
            <div className="max-w-7xl mx-auto px-5 lg:px-2 relative z-10 h-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center h-full">
                    ...
                    <div className="flex flex-col justify-center gap-1 md:gap-2 -mt-4 md:-mt-12 text-center md:text-left">
                    ...
                    <div className="relative flex items-center justify-center md:justify-end h-full">
                        <div className="relative w-[260px] pt-2 sm:pt-0 sm:w-[300px] md:w-[480px] lg:w-[450px] -mt-16 md:-mt-60 z-30">
                            {/* Glow behind product */}
